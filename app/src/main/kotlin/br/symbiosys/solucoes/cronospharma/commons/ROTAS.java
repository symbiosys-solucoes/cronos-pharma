...
public final class ROTAS {
    ...
    public static final String PETRONAS_ENVIO_CPR =  BASE_URL + "/petronas/envio/cpr";
    public static final String PETRONAS_ENVIO_PRODUTOS =  BASE_URL + "/petronas/envio/produtos";
    ...
    public static final String PETRONAS_ENVIO_NOTAS =  BASE_URL + "/petronas/envio/notas";
