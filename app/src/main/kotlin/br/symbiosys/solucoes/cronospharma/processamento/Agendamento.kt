...
import br.symbiosys.solucoes.cronospharma.controllers.processamento.ProcessamentoDto
import br.symbiosys.solucoes.cronospharma.entidades.TipoIntegracao
import br.symbiosys.solucoes.cronospharma.entidades.closeup.CloseUpRepository
import br.symbiosys.solucoes.cronospharma.entidades.closeup.Pedido
import br.symbiosys.solucoes.cronospharma.entidades.closeup.geraEstoqueCloseUp
import br.symbiosys.solucoes.cronospharma.entidades.closeup.geraPrecoCloseUp
...
import br.symbiosys.solucoes.cronospharma.entidades.ems.EMSRepository
import br.symbiosys.solucoes.cronospharma.entidades.ems.PedidoEMS
import br.symbiosys.solucoes.cronospharma.entidades.ems.geraEstoqueEMS
    ...
    private fun gerarArquivoDeRetornoNF(diretorio: Diretorio) {
        ...
        when(diretorio.tipoIntegracao){
            TipoIntegracao.EMS -> {
                ...
                idsEMS.forEach {
                    bloqueioMovimentoRepository.executaRegrasTipoGravarRetornos(it)
