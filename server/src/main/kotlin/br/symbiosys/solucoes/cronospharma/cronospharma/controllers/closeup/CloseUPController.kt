package br.symbiosys.solucoes.cronospharma.cronospharma.controllers.closeup

import br.symbiosys.solucoes.cronospharma.cronospharma.processamento.CloseUPService
...
@RestController
@RequestMapping("/api/v1/closeup")
class CloseUPController (private val service: CloseUPService){
